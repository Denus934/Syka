...
/* Получение байта сообщения. */ 
#define IOCTL_FIND_СHAR _IOWR(MAJOR_NUM, 3, int) 
/* Эта IOCTL используется как для ввода, так и для вывода. Она получает
 * от пользователя символ, n, и возвращает кол-во встреченных символов. 
 */ 
#define IOCTL_FIND_STR _IOWR(MAJOR_NUM, 4, int) 
